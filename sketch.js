...
function keyPressed(){
	...
	//"n" toogle costruisci ponti
	if(keyCode == 78){
		myPlayer.building = !myPlayer.building;
	}
	//"e" costruisce un ponte
	if(keyCode == 69 && !myPlayer.building){
...
/*
	ritorna se l'elemento [int, int] è presente in array
*/
